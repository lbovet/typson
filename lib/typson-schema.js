...
(function (underscore, Q, _traverse, typson) {
    ...
    var validationKeywords = [ "type", "minimum", "exclusiveMinimum", "maximum", "exclusiveMaximum", "multipleOf", "minLength", "maxLength", "format", "pattern", "minItems", "maxItems", "uniqueItems", "default", "additionalProperties", "_requiredIfAvailable", "_hiddenByDefault" ];
