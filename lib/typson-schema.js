...
(function (underscore, Q, _traverse, typson) {
    ...
    var annotedValidationKeywordPattern = /@_requiredIfAvailable|@_hiddenByDefault|(@|@_)[a-z0-9A-Z\']+\s.*|(@_requiredIfAvailable|@_hiddenByDefault|@default|@maxLength)/gi;
    ...
    var EMPTY_ANNOTATIONS = ["_requiredIfAvailable", "_hiddenByDefault"];
    /**
